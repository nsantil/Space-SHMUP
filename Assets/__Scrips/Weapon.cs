...
public class WeaponDefinition
{
    ...
    [Tooltip("Color of Projectile that is fired")]
    ...
    public float delayBetweenShots = 0;/// changed from 0 to prevent lazer 
...
public class Weapon : MonoBehaviour{
    ...
    void Start()
    {
        ...
        // calll setype for the defaule _ type set in the inspector
        SetType(_type);

        //find the fireevent of a heor component in the parent hierarchy
   ...
   if(weaponModel != null) Destroy(weaponModel);
        ...
        nextShotTime = 0;// you can fire immediately after -typer is set
 }
    ...
    private void Fire()
    {
       ...
       // nextShotTime = Time.time + def.delayBetweenShots; /// added this so try to slow the firerate
    }
